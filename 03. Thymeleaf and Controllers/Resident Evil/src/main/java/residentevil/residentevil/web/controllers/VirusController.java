package residentevil.residentevil.web.controllers;
...
import residentevil.residentevil.domain.models.binding.VirusAddBindingModel;
import residentevil.residentevil.domain.views.CapitalListViewModel;
import residentevil.residentevil.service.CapitalService;
...
public class VirusController extends BaseController{
    ...
    @GetMapping("/add")
    public ModelAndView addVirus(ModelAndView modelAndView, @ModelAttribute(name = "bindingModel") VirusAddBindingModel bindingModel) {
